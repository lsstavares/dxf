...
var polyline = function polyline(entity) {
  ...
  return (0, _transformBoundingBoxAndElement["default"])(bbox, "<path data-dxf-layer=\"".concat(entity.layer, "\" d=\"").concat(d, "\" />"), entity.transforms);
};
...
var circle = function circle(entity) {
  ...
  var element0 = "<circle data-dxf-layer=\"".concat(entity.layer, "\" cx=\"").concat(entity.x, "\" cy=\"").concat(entity.y, "\" r=\"").concat(entity.r, "\" />");
