...
var _entityToPolyline = _interopRequireDefault(require("./entityToPolyline.js"));
var _denormalise = _interopRequireDefault(require("./denormalise.js"));
var _logger = _interopRequireDefault(require("./util/logger.js"));
var _rotate = _interopRequireDefault(require("./util/rotate.js"));
var _toPiecewiseBezier = _interopRequireWildcard(require("./util/toPiecewiseBezier.js"));
var _transformBoundingBoxAndElement = _interopRequireDefault(require("./util/transformBoundingBoxAndElement.js"));
...
var polyline = function polyline(entity) {
  ...
  return (0, _transformBoundingBoxAndElement["default"])(bbox, "<path data-dxf-layer=\"".concat(entity.layer, "\" data-dxf-depth=\"").concat(entity.z, "\" d=\"").concat(d, "\" />"), entity.transforms);
};
...
var circle = function circle(entity) {
  ...
  var element0 = "<circle data-dxf-layer=\"".concat(entity.layer, "\" data-dxf-depth=\"").concat(entity.z, "\"  cx=\"").concat(entity.x, "\" cy=\"").concat(entity.y, "\" r=\"").concat(entity.r, "\" />");
...
var _default = function _default(parsed, id) {
  ...
  return elements.join('\n'); // `<g transform="matrix(1,0,0,-1,0,0)"> ${elements.join('\n')} </g>`
};
